    ...
    <div class="board">
        ...
        <main>
            ...
            <div class="main-body">
                ...
                $dsn = 'mysql:host=127.0.0.1;dbname=est_jobs';
                $usuario = 'root';
                $contraseña = '';
                ...
                try {
                    ...
                    // Consulta SQL para seleccionar usuarios con isStaff en true
                    $consulta = "SELECT * FROM users WHERE isStaff = true";
                    ...
                    ?>
                        <div class="tarjeta">
                            <img src="<?php echo $usuario['AvatarUrl']; ?>" alt="Avatar">
