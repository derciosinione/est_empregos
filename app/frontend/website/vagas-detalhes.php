...
<header>
    ...
    <nav class="navbar navbar-expand-lg fixed-top navbar-dark bg-dark">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav mx-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link active" href="vagas.php">Vagas</a>
                </li>
                <li class="nav-item">
    ...
    <section class="course-intro">
        <div>
            <h2>Desenvolvedor Backend C# Senior</h2>
            <p><strong>Construir programas de computador de maneira fácil e rápida</strong></p>
            <p class="text-gray">Empresa <i class="fas fa-angle-double-right"></i> Kiari Code</p>
            ...
            <div class="options display-flex">
                ...
                <span class="bg-blue"><a href="criar-conta.php">Inscrever-se</a></span>
            </div>
...
<main>
    <section class="course-overview">
        <div>
            <div>
                <h5>Descrição da vagas</h5>
                <p>O vaga <b>"Introdução à Programação de Computadores"</b> é projetado para fornecer aos alunos uma
                    base sólida nos conceitos fundamentais da programação. Este vaga é ideal para aqueles que têm pouca
            ...
            <div>
                <h5>Metodologia</h5>
                <p>O vaga combina aulas teóricas com atividades práticas e projetos. Os alunos terão a oportunidade de
            ...
            <div>
                <h5>Público-Alvo</h5>
                <p>Este vaga é destinado a estudantes, profissionais de diversas áreas e qualquer pessoa interessada em
        ...
        <aside>
            <ul>
                ...
                <li><a href="criar-conta.php" class="btn btn-primary btn-lg">Inscrever-se</a></li>
            </ul>
        </aside>
    </section>
